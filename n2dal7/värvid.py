...
värvid = """snow {ghost white} {white smoke} gainsboro {floral white}
...
värvid = värvid.replace("}", "")
värvid = värvid.replace("{", "")
värvid = värvid.replace("\n", "")
värvid = värvid.split(" ")
värvid = list(filter(None, värvid)) # eemaldan tühjad elemendid
speed("fastest")
for värv in värvid:
    print(värv)
    nurk = 360 / len(värvid)
    ...
    try:
        ...
        print("turtle ei tunne antud värvi: " + värv)
    forward(200)
    penup()
    right(180)
    forward(200)
